...
function Weather() {
    ...
    const [weatherInfo, setWeatherInfo] = useState({cityname: "", country:"", info: "", description: "", temperature: "", feelsLike: "", tempMin: "", tempMax:""});
    ...
    <body className={background}>
        <div className='container'>
           <div className='search-container'>
              <input className= "search-button" type="text" onChange={searchCity} value = {city}/>
